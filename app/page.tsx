      ...
      <div className="relative z-10">
        ...
        <div className="mx-auto max-w-7xl px-4 py-4 md:py-6 lg:px-8">
          ...
          <div className="mx-auto text-center">
            <h1 className="text-3xl font-extrabold leading-tight text-gray-900 md:text-5xl lg:text-[3.75rem] lg:leading-[1.15] text-balance">
              {config.headline}
            ...
            {/* Trust indicators — green checkmarks (neutral theme) */}
